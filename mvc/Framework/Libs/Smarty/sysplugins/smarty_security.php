...
class Smarty_Security
{
    ...
    /**
     * This is an array of trusted student classes.
     *
     * If empty access to all student classes is allowed.
    ...
    /**
     * Check if student class is trusted.
     *
     * @param  string                  $class_name
     * @param  object                  $compiler   compiler object
     * @return boolean                 true if class is trusted
     * @throws SmartyCompilerException if student class is not trusted
     */
    public function isTrustedStaticClass($class_name, $compiler)
    {
        ...
        $compiler->trigger_template_error("access to student class '{$class_name}' not allowed by security setting");
